"use strict";(()=>{var e={};e.id=5241,e.ids=[5241],e.modules={53524:e=>{e.exports=require("@prisma/client")},20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},83741:(e,t,o)=>{o.r(t),o.d(t,{originalPathname:()=>f,patchFetch:()=>b,requestAsyncStorage:()=>u,routeModule:()=>c,serverHooks:()=>g,staticGenerationAsyncStorage:()=>p});var r={};o.r(r),o.d(r,{GET:()=>m,dynamic:()=>d});var i=o(49303),s=o(88716),a=o(60670),n=o(87070),l=o(9487);let d="force-dynamic";async function m(e,{params:t}){try{let e=await l._.bookingWidget.findUnique({where:{id:t.id,isActive:!0},include:{venue:{select:{id:!0,name:!0,isActive:!0}}}});if(!e||!e.venue.isActive)return new n.NextResponse(`
        <!DOCTYPE html>
        <html>
        <head>
    ...
    `;return new n.NextResponse(a,{headers:{"Content-Type":"text/html","X-Frame-Options":"ALLOWALL","Access-Control-Allow-Origin":"*"}})}catch(e){return console.error("Get widget embed error:",e),new n.NextResponse(`
      ...
      `,{status:500,headers:{"Content-Type":"text/html","X-Frame-Options":"ALLOWALL","Access-Control-Allow-Origin":"*"}})}}let c=new i.AppRouteRouteModule({definition:{kind:s.x.APP_ROUTE,page:"/api/widgets/[id]/embed/route",pathname:"/api/widgets/[id]/embed",filename:"route",bundlePath:"app/api/widgets/[id]/embed/route"},resolvedPagePath:"/home/ubuntu/sully-booking-system-v2/app/app/api/widgets/[id]/embed/route.ts",nextConfigOutput:"",userland:r}),{requestAsyncStorage:u,staticGenerationAsyncStorage:p,serverHooks:g}=c,f="/api/widgets/[id]/embed/route";function b(){return(0,a.patchFetch)({serverHooks:g,staticGenerationAsyncStorage:p})}},9487:(e,t,o)=>{o.d(t,{_:()=>i});var r=o(53524);let i=globalThis.prisma??new r.PrismaClient}};var t=require("../../../../../webpack-runtime.js");t.C(e);var o=e=>t(t.s=e),r=t.X(0,[9276,5972],()=>o(83741));module.exports=r})();